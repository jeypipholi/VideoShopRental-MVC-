...
namespace VideoShopRentalV3.Data.Migrations
{
    ...
    [Migration("20250205143107_changeRentalHeader")]
    partial class changeRentalHeader
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VideoShopRentalV3.Models.Customer", b =>
                {
            ...
            modelBuilder.Entity("VideoShopRentalV3.Models.Movie", b =>
                {
            ...
            modelBuilder.Entity("VideoShopRentalV3.Models.RentalDetail", b =>
                {
            ...
            modelBuilder.Entity("VideoShopRentalV3.Models.RentalHeader", b =>
                {
                    b.Property<int>("RentalHeaderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VideoShopRentalV3.Models.Movie", b =>
                {
                    b.HasOne("VideoShopRentalV3.Models.RentalHeader", null)
                        .WithMany("Movies")
            ...
            modelBuilder.Entity("VideoShopRentalV3.Models.RentalDetail", b =>
                {
                    b.HasOne("VideoShopRentalV3.Models.Movie", "Movie")
                        .WithMany("RentalDetails")
                        .HasForeignKey("MovieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("VideoShopRentalV3.Models.RentalHeader", "RentalHeader")
                        .WithMany("RentalDetails")
                        .HasForeignKey("RentalHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("VideoShopRentalV3.Models.RentalHeader", b =>
                {
                    b.HasOne("VideoShopRentalV3.Models.Customer", "Customer")
